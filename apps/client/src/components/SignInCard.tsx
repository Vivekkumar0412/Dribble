...
export default function SignInCard({ setOpenSignInCard }: CardProps) {
    ...
    return (
        <OpacityBackground onBgClick={() => setOpenSignInCard(false)}>
            ...
            >
                ...
                <section className="flex justify-center items-center flex-col h-full w-[50%] bg-neutral-950 border border-neutral-800  relative">
